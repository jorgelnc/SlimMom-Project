import { __module as L } from "../../../_virtual/react.development.jsx";
/**
 * @license React
...
var pr;
function jt() {
  return pr ? L.exports : (pr = 1, function(Z, s) {
    process.env.NODE_ENV !== "production" && function() {
      typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u" && typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart == "function" && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(new Error());
      var vr = "18.2.0", $ = Symbol.for("react.element"), Re = Symbol.for("react.portal"), M = Symbol.for("react.fragment"), ee = Symbol.for("react.strict_mode"), re = Symbol.for("react.profiler"), te = Symbol.for("react.provider"), N = Symbol.for("react.context"), A = Symbol.for("react.forward_ref"), x = Symbol.for("react.suspense"), ne = Symbol.for("react.suspense_list"), C = Symbol.for("react.memo"), W = Symbol.for("react.lazy"), yr = Symbol.for("react.offscreen"), Ce = Symbol.iterator, hr = "@@iterator";
      function we(e) {
      ...
      var mr = !1, gr = !1, br = !1, _r = !1, Er = !1, T = {
      ...
      };
      {
        ...
        for (var ie in ue)
          ue.hasOwnProperty(ie) && Rr(ie, ue[ie]);
      }
      function Ae() {
      }
      ...
      function Y(e) {
        if (Or(e))
          return f("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", Tr(e)), je(e);
      }
      function Sr(e, r, t) {
        var n = e.displayName;
        if (n)
      ...
      function jr(e, r, t) {
        ...
        if (r != null) {
          $e(r) && (o = r.ref, Ar(r)), Me(r) && (Y(r.key), u = "" + r.key), i = r.__self === void 0 ? null : r.__self, c = r.__source === void 0 ? null : r.__source;
          for (n in r)
      ...
      function de(e, r) {
        return typeof e == "object" && e !== null && e.key != null ? (Y(e.key), Lr("" + e.key)) : r.toString(36);
      }
      function z(e, r, t, n, a) {
        ...
        if (o) {
          ...
          if (V(c)) {
            var d = "";
            l != null && (d = We(l) + "/"), z(c, r, d, "", function(kt) {
              return kt;
            });
          } else
            c != null && (S(c) && (c.key && (!i || i.key !== c.key) && Y(c.key), c = Dr(
              c,
        ...
        if (V(e))
          ...
          if (typeof Ee == "function") {
            var fr = e;
            Ee === fr.entries && (xe || O("Using Maps as children is not supported. Use an array of keyed ReactElements instead."), xe = !0);
            for (var St = Ee.call(fr), lr, Pt = 0; !(lr = St.next()).done; )
              p = lr.value, v = h + de(p, Pt++), y += z(p, r, t, v, a);
          } else if (u === "object") {
            var dr = String(e);
            throw new Error("Objects are not valid as a React child (found: " + (dr === "[object Object]" ? "object with keys {" + Object.keys(e).join(", ") + "}" : dr) + "). If you meant to render a collection of children, use an array instead.");
          }
        }
        return y;
      }
...
Your code should look like: 
  const MyComponent = lazy(() => import('./MyComponent'))`, a), a.default;
      ...
      function Ye(e) {
        return !!(typeof e == "string" || typeof e == "function" || e === M || e === re || Er || e === ee || e === x || e === ne || _r || e === yr || mr || gr || br || typeof e == "object" && e !== null && (e.$$typeof === W || e.$$typeof === C || e.$$typeof === te || e.$$typeof === N || e.$$typeof === A || // This needs to include all possible module reference object
...
` + ye + e;
      ...
      function Je(e, r) {
        ...
        var u;
        u = ve.current, ve.current = null, st();
        try {
          if (r) {
            var o = function() {
              throw Error();
...
` + i[l].replace(" at new ", " at ");
          ...
          he = !1, ve.current = u, ct(), Error.prepareStackTrace = a;
        }
...
Check the top-level render call using <` + t + ">.");
      ...
      function ur(e, r, t) {
        ...
        var i = jr.apply(this, arguments);
        if (i == null)
          return i;
        if (n)
          for (var c = 2; c < arguments.length; c++)
            ar(arguments[c], e);
        return e === M ? mt(i) : or(i), i;
      }
      var ir = !1;
      function gt(e) {
      ...
      function bt(e, r, t) {
        for (var n = Ir.apply(this, arguments), a = 2; a < arguments.length; a++)
      ...
      s.Children = Ot, s.Component = R, s.Fragment = M, s.Profiler = re, s.PureComponent = se, s.StrictMode = ee, s.Suspense = x, s.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = T, s.cloneElement = wt, s.createContext = Ur, s.createElement = Ct, s.createFactory = Tt, s.createRef = Cr, s.forwardRef = Br, s.isValidElement = S, s.lazy = zr, s.memo = Hr, s.startTransition = _t, s.unstable_act = Rt, s.useCallback = et, s.useContext = Kr, s.useDebugValue = nt, s.useDeferredValue = ot, s.useEffect = Xr, s.useId = ut, s.useImperativeHandle = tt, s.useInsertionEffect = Jr, s.useLayoutEffect = Zr, s.useMemo = rt, s.useReducer = qr, s.useRef = Qr, s.useState = Gr, s.useSyncExternalStore = it, s.useTransition = at, s.version = vr, typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u" && typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop == "function" && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop(new Error());
    }();
