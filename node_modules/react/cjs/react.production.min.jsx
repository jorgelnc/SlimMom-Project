import { __exports as r } from "../../../_virtual/react.production.min.jsx";
/**
 * @license React
...
function K() {
  if (I)
    return r;
  I = 1;
  var y = Symbol.for("react.element"), q = Symbol.for("react.portal"), T = Symbol.for("react.fragment"), V = Symbol.for("react.strict_mode"), A = Symbol.for("react.profiler"), D = Symbol.for("react.provider"), U = Symbol.for("react.context"), F = Symbol.for("react.forward_ref"), L = Symbol.for("react.suspense"), M = Symbol.for("react.memo"), N = Symbol.for("react.lazy"), k = Symbol.iterator;
  function z(e) {
  ...
  function d(e, t, n, u, o) {
    ...
    if (s)
      return s = e, o = o(s), e = u === "" ? "." + E(s, 0) : u, j(o) ? (n = "", e != null && (n = e.replace(P, "$&/") + "/"), d(o, t, n, "", function(a) {
        return a;
      })) : o != null && (R(o) && (o = B(o, n + (!o.key || s && s.key === o.key ? "" : ("" + o.key).replace(P, "$&/") + "/") + e)), t.push(o)), 1;
    if (s = 0, u = u === "" ? "." : u + ":", j(e))
  ...
  var l = { current: null }, h = { transition: null }, G = { ReactCurrentDispatcher: l, ReactCurrentBatchConfig: h, ReactCurrentOwner: S };
  return r.Children = { map: _, forEach: function(e, t, n) {
    ...
    return e;
  } }, r.Component = p, r.Fragment = T, r.Profiler = A, r.PureComponent = m, r.StrictMode = V, r.Suspense = L, r.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = G, r.cloneElement = function(e, t, n) {
    if (e == null)
    ...
    return e = { $$typeof: U, _currentValue: e, _currentValue2: e, _threadCount: 0, Provider: null, Consumer: null, _defaultValue: null, _globalName: null }, e.Provider = { $$typeof: D, _context: e }, e.Consumer = e;
